...
class LwF_domainnet(BaseLearner):
    ...
    def incremental_train(self, data_manager):
        ...
        if self._cur_task == 6:
            exit("finish")
        self._total_classes = self._known_classes + 345
    ...
    def _init_train(self,train_loader,test_loader,optimizer,scheduler):
        ...
        for _, epoch in enumerate(prog_bar):
            ...
            self._cur_task, epoch+1, self.init_epoch, losses/len(train_loader), train_acc)
    ...
    def _update_representation(self, train_loader, test_loader, optimizer, scheduler):
        ...
        for _, epoch in enumerate(prog_bar):
            ...
            for i, (_, inputs, targets) in enumerate(train_loader):
                ...
                loss_clf = F.cross_entropy(logits[:,self._known_classes:], targets)
                loss_kd =_KD_loss(logits[:,:self._known_classes],self._old_network(inputs)["logits"],self.T)
